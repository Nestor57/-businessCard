  ...
  .state('contacts',{
   ...
   .state('practice',{
    ...
    templateUrl:'pages/future.html'
                  ...
                  .state('technic',{
    url:'/technic',
    templateUrl:'pages/technic.html'
  })
...
$('#startWords-'+i).animate({opacity:'1'},400);

//.animate({marginLeft:'50%',marginRight:'-50%',backgroundColor:'rgba(255,255,255,1)'},700,"swing",function(){
...
$('.moreToggle').animate({opacity:'1',top:'0'},600,function(){});
  i=1;
...
if ($('#practic-1').height()+48*2<window.pageYOffset+$(window).height()*0.5){

  $('#practic-2').animate({opacity:'1'},600);
}

if ($('#practic-1').height()+$('#practic-2').height()+48*3<window.pageYOffset+$(window).height()*0.5){

  $('#practic-3').animate({opacity:'1'},600);
}

if ($('#practic-1').height()+$('#practic-2').height()+$('#practic-3').height()+48*4<window.pageYOffset+$(window).height()*0.5){

  $('#practic-4').animate({opacity:'1'},600);
}

if ($('#practic-1').height()+$('#practic-2').height()+$('#practic-3').height()+
  $('#practic-4').height()+48*5<window.pageYOffset+$(window).height()*0.5){

  $('#practic-5').animate({opacity:'1'},600);
}

if ($('#practic-1').height()+$('#practic-2').height()+$('#practic-3').height()+
  $('#practic-4').height()+$('#practic-5').height()+48*6<window.pageYOffset+$(window).height()*0.5){

  $('#practic-6').animate({opacity:'1'},600);
}

if ($('#practic-1').height()+$('#practic-2').height()+$('#practic-3').height()+
  $('#practic-4').height()+$('#practic-5').height()+$('#practic-6').height()+48*7<window.pageYOffset+$(window).height()*0.5){
